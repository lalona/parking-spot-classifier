...
def create_parkingnet(width, height, depth, classes):
		...
		# inception module 5x5
		branch3x3dbl = conv2d_bn(x, 8, 1, 1)
		branch3x3dbl = conv2d_bn(branch3x3dbl, 20, 5, 5, strides=(2, 2), padding='valid')

		branch_pool = MaxPooling2D((5, 5), strides=(2, 2))(x)
		x = concatenate([branch3x3dbl, branch_pool], axis=channel_axis, name='mixed1')

		# inception module 3x3
		branch3x3dbl = conv2d_bn(x, 10, 1, 1)
		branch3x3dbl = conv2d_bn(branch3x3dbl, 30, 3, 3, strides=(2, 2), padding='valid')

		branch_pool = MaxPooling2D((3, 3), strides=(2, 2))(x)
		x = concatenate([branch3x3dbl, branch_pool], axis=channel_axis, name='mixed2')
