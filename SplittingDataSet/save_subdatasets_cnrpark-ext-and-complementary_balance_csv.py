...
import argparse
from save_subdatasets_utils import get_subsets_cnrpark, count_quantity_of_classes, get_paths_and_label, create_subset_directorie, save_subsets_info, save_subset, save_subset
import random
import ntpath
...
size_training_data_cnrpark = 10
size_test_data_cnrpark = 5
...
def main():
	...
	cnrpark_data_paths, cnrpark_subsets_info = get_subsets_cnrpark(cnrpark_info_filename, size_training_data_cnrpark, size_test_data_cnrpark)
	...
	complementary_vehicles_data, total_complementary_vehicles = get_paths_and_label(complementary_vehicles_path, '1')
	complementary_nonvehicles_data, total_complementary_nonvehicles = get_paths_and_label(complementary_nonvehicles_path, '0')
	...
	save_subsets_info(subsets=cnrpark_subsets_info, subsets_dir=subset_dir,
