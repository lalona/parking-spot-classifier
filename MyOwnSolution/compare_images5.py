...
import ntpath
import json
from compare_image_utils import get_images_info_by_parkinglot, tryMethodsOnSpaces
...
def main():
		...
		dataset, dataset_name = tryMethodsOnSpaces(images_info_by_patkinglot, database=database)
