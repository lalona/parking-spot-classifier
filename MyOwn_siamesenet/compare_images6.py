...
import ntpath
import json
from compare_image_utils import get_images_info_by_parkinglot, getDataset, getDataset2, getDataset3, getDataset4, getImagesInfo, getDataset5, getDataset6, getDataset7, getDataset4_1
import ntpath
...
def main():
		...
		if database == 'cnrpark':
			...
			images_info_by_patkinglot = get_images_info_by_parkinglot(info_filename, parkinglot_key='parkinglot',
																																	database=database)
		images_info = getImagesInfo(info_filename, database=database)
