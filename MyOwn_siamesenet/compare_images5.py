...
import ntpath
import json
from compare_image_utils import get_images_info_by_parkinglot, getDataset, getDataset2, getDataset3, getDataset7, getDataset_ForTests1, getDataset4_1
import ntpath
...
def main():
		...
		#dataset, dataset_name = getDataset3(images_info_by_patkinglot, specific_database=specific_database, empty_spaces_by_space=50, half_total_comparisions=50)
		dataset, dataset_name = getDataset_ForTests1(images_info_by_patkinglot, specific_database=specific_database, empty_spaces=5)
